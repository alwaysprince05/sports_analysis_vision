// Hockey Match Analytics v3.0 (C++ port) | dev: tubakhxn
// Requires: OpenCV 4.x built with DNN module, and yolov8n.onnx exported via:
//   yolo export model=yolov8n.pt format=onnx
// Build:  g++ hockey_match_analytics.cpp -o hockey `pkg-config --cflags --libs opencv4` -O2
// Run:    ./hockey video.mp4 yolov8n.onnx
