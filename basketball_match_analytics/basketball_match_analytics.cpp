// Basketball Match Analytics v3.1 (C++ port) | dev: tubakhxn
// Requires: OpenCV 4.x built with DNN module, and yolov8n.onnx exported via:
//   yolo export model=yolov8n.pt format=onnx
// Note: heatmap/dashboard PNG export (matplotlib in the Python version) is not ported here —
// this build focuses on the live annotated video output. Position log is printed to CSV instead.
// Build:  g++ basketball_match_analytics.cpp -o basketball `pkg-config --cflags --libs opencv4` -O2
// Run:    ./basketball video.mp4 yolov8n.onnx
