// Volleyball Rally & Spike Analytics v2.0 (C++ port) | dev: tubakhxn
// Requires: OpenCV 4.x built with DNN module, and yolov8n.onnx exported via:
//   yolo export model=yolov8n.pt format=onnx
// Build:  g++ volleyball_analytics.cpp -o volleyball `pkg-config --cflags --libs opencv4` -O2
// Run:    ./volleyball video.mp4 yolov8n.onnx
